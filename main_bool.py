...
#Desired n-gram length(s) -> 1,2,or 3 length values should be chosen
n =[1]
###Create a dictionary of features (keys are the unique system calls, values are the number of system call traces that have that particular system call)
featDict = dict()
...
def feature_freq_bool(listname, n, features):
    counts = dict()
...
with open('test_data' + s + '_bool.csv', 'w', newline="") as csvfile:
